  ...
  return (
    <>
      <div className="layout-content">
        ...
        <Row gutter={[24, 0]}>
         <Col xs={24} md={12} sm={24} lg={11} xl={11} className="mb-24">
         <Card
            bordered={false}
          ...
          >
            <List
              ...
              dataSource={orders.slice(Math.max(orders.length - 3, 0))}
              renderItem={(item) => (
                <List.Item
...
<Paragraph className="lastweek" style={{ marginBottom: 24 }}>
                ...
                >
                  ...
                  {<CopyOutlined />} Copy Referral Code
                </Button>
                </Tooltip>
              </div>
            </Card>
